...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-jh0f62w.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-jh0f62w.containers.anotherwebservice.com/
...
```
git clone git@github.com:Inregist/container-jh0f62w.git
cd container-jh0f62w
```
...
```
docker attach container-jh0f62w
```
